...
ggplot(df, aes(x = Program, y = error.dG)) +
  geom_hline(yintercept =  0) +
  geom_boxplot() +
  stat_compare_means(label.x = 1, label.y = 0.17) +
...
list.files("Figures/SI_Figure_X_Meltwin_MeltR_agrrement_with_NN")

ggsave("Figures/SI_Figure_X_Meltwin_MeltR_agrrement_with_NN/SI_Figure_X_Meltwin_MeltR_agrrement_with_NN.svg",
       scale = 1.5)
