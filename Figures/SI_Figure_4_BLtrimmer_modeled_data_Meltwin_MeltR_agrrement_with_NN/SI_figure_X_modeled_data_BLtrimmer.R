...
df = read.csv("Figures/SI_Figure_4_BLtrimmer_modeled_data_Meltwin_MeltR_agrrement_with_NN/Xia_et_al_data.csv")
...
write.csv(df.Modeled_absorbance, "Figures/SI_Figure_4_BLtrimmer_modeled_data_Meltwin_MeltR_agrrement_with_NN/Modeled_Xia_data.csv", row.names = FALSE)
write.csv(df.Energies, "Figures/SI_Figure_4_BLtrimmer_modeled_data_Meltwin_MeltR_agrrement_with_NN/Modeled_Xia_energies.csv", row.names = FALSE)
